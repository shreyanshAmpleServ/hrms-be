...
const createAppointmentLatter = async (req, res, next) => {
    try {
        ...
        const reqData = await AppointmentLatterService.createAppointmentLatter(data);
...
const findAppointmentLatterById = async (req, res, next) => {
    try {
        const reqData = await AppointmentLatterService.findAppointmentLatterById(req.params.id);
...
const updateAppointmentLatter = async (req, res, next) => {
    try {
        const data = {
            ...
            log_inst: req.user.log_inst,  }
        const reqData = await AppointmentLatterService.updateAppointmentLatter(req.params.id, data);
...
const getAllAppointmentLatter = async (req, res, next) => {
    try {
        ...
        const data = await AppointmentLatterService.getAllAppointmentLatter(search,Number(page), Number(size),startDate && moment(startDate),endDate && moment(endDate));
