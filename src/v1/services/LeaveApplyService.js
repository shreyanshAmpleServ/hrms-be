...
const getAllLeaveApplication = async (search,page,size ,startDate, endDate) => {
    return await LeaveApplyModel.getAllLeaveApplication(search,page,size ,startDate, endDate);
};
