...
router.post(
  "/activities",
  authenticateToken,
  activitiesController.createActivitiesStatus
);
...
router.get(
  "/activities",
  authenticateToken,
  activitiesController.getAllActivitiesStatuses
);
router.get(
  "/grouped-activities",
  authenticateToken,
  activitiesController.getGroupActivities
);

router.get(
  "/activityTypes",
  authenticateToken,
  activitiesController.getActivitiesTypes
);
