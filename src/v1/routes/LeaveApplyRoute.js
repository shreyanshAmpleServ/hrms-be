...
router.post(
  ...
  authenticateToken,
  (req, res, next) =>
    setupNotificationMiddleware(req, res, next, "Leave Applications", "create"),
...
router.put(
  ...
  authenticateToken,
  (req, res, next) =>
    setupNotificationMiddleware(req, res, next, "Leave Applications", "update"),
...
router.delete(
  ...
  authenticateToken,
  (req, res, next) =>
    setupNotificationMiddleware(req, res, next, "Leave Applications", "delete"),
