...
const createModuleRelatedTo = async (data) => {
    try {
        ...
        throw new CustomError(`Error creating Module Related To : ${error.message}`, 500);
    }
};
...
const updateModuleRelatedTo = async (id, data) => {
    try {
        ...
        throw new CustomError(`Error updating Module Related To : ${error.message}`, 500);
    }
};
...
const deleteModuleRelatedTo = async (id) => {
    try {
        ...
        throw new CustomError(`Error deleting Module Related To : ${error.message}`, 500);
    }
};
