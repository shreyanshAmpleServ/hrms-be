...
const updateAttachment = async (id, data) => {
    try {
        ...
        throw new CustomError(`Error updating file attachment: ${error.message}`, 500);
    }
};
...
const deleteAttachment = async (id) => {
    try {
        ...
        throw new CustomError(`Error deleting file attachment: ${error.message}`, 500);
    }
};
...
const getAllAttachment = async (search ,page , size ,startDate, endDate ,related_type) => {
    try {
        ...
        if(related_type){filters.related_entity_type = {equals :related_type} }
