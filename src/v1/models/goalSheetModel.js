...
// const serializeGoalSheetAssignmentData = (data, isUpdate = false) => {
//   const obj = {
...
//   if (!isUpdate) {
//     obj.employee_id = Number(data.employee_id);
//     obj.appraisal_cycle_id = Number(data.appraisal_cycle_id);
//   }
...
//       },
//       data: {
//         ...serializeGoalSheetAssignmentData(data, true), // true => update mode
